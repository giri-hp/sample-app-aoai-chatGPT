                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Chat PH2</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Ask questions related to PH2 Assessments. Sure Admin, Batery Safety Mode, MPM Unlock, Sure Recover and Tamper Lock.  </h2>
                            </Stack>
                        ) : (
